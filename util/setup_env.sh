...
gpu-simulator/bin/release/accel-sim.out -trace util/tracer_nvbit/traces/kernelslist -config ./gpgpu-sim/configs/tested-cfgs/SM86_RTX3070/gpgpusim.config -config ./gpu-simulator/configs/tested-cfgs/SM86_RTX3070/trace.config
